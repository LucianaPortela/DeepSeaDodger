...
class Menu:
    ...
    def run(self):
        ...
        while True:
            ...
            self.menu_text(60, "Deep Sea", C_BLUE, ((WIN_WIDTH / 2), 70))
            self.menu_text(55, "Dodge", C_BLUE, ((WIN_WIDTH / 2), 120))

            for i in range(len(MENU_OPTION)):
                if i == menu_option:
                    self.menu_text(30, MENU_OPTION[i], C_ORANGE, ((WIN_WIDTH / 2), 200 + 40 * i))
                else:
